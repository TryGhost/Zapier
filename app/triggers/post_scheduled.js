...
const subscribeWebhook = _.partial(webhooks.subscribe, 'post.scheduled');
const unsubscribeWebhook = webhooks.unsubscribe;

const handleWebhook = (z, bundle) => {
    const { post } = bundle.cleanedRequest;
    return [post.current];
};

const getLatestScheduledPost = (z, bundle) => {
...
module.exports = {
    ...
    operation: {
        ...
        performList: getLatestScheduledPost,
        ...
        sample: {
            ...
            created_at: '2020-10-13T08:10:10.000Z',
            updated_at: '2020-10-13T08:10:10.000Z',
            published_at: '2020-10-13T09:00:00.000Z',
            custom_excerpt:
