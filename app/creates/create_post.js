    ...
    operation: {
        inputFields: [
                    ...
                    return [
                        {
                            ...
                            label: 'Content (HTML)',
                            helpText:
                                'HTML content that will be converted to rich-text (Mobiledoc). Please be aware that any custom styling or layout may be lost during conversion, you can read more about it [in our docs](https://docs.ghost.org/api/admin/#source-html)',
                            required: false,
                            type: 'text',
                        },
                    ];
                    ...
                    return [
                        {
                            ...
                            helpText:
                                'Mobiledoc is the raw JSON format that Ghost uses to store post contents, you can read more about it [in our docs](https://docs.ghost.org/concepts/posts/#document-storage)',
                            required: false,
                            type: 'text',
                        },
                    ];
            ...
            { key: 'twitter_image', required: false },
            {
                ...
                helpText:
                    'Include custom styles or scripts with the post, see [the docs](https://docs.ghost.org/faq/publishing-options/#inject-custom-code) for more info.',
                required: false,
                type: 'text',
            },
            {
