    ...
    describe('Create Member', function () {
        ...
        it('creates a member and sends a signup confirmation email', function () {
            ...
            return appTester(App.creates.create_member.operation.perform, bundle).then((member) => {
                ...
                expect(member.subscribed).toBe(false);
            });
        });
        ...
        it('handles 500 errors with JSON error body', function () {
            ...
            apiMock.post('/ghost/api/admin/members/?send_email=true').reply(500, {
                errors: [
                    {
        ...
        it('creates a member with label', function () {
            ...
            apiMock
                .post('/ghost/api/admin/members/?send_email=false&email_type=signup', {
                    members: [
                        {
                            name: 'Test Member',
                            email: 'test@example.com',
        ...
        it('creates a member with default newsletters when the default flag is set', function () {
            let bundle = Object.assign(
                {},
                { authData },
                {
        ...
        describe('dynamic input fields', function () {
            ...
            it('shows the subscribed field for a single newsletter', function () {
                ...
                return appTester(
                    App.creates.create_member.operation.inputFields[SUBSCRIPTION_FIELD],
                    bundle,
                ).then(([field]) => {
            ...
            it('shows the default newsletters field for multiple newsletters', function () {
                ...
                return appTester(
                    ...
                    expect(field.key).toEqual('newsletters_default');
            ...
            it('shows the newsletters field when default newsletters are disabled', function () {
                ...
                return appTester(
                    App.creates.create_member.operation.inputFields[NEWSLETTERS_FIELD],
                    bundle,
                ).then(([field]) => {
