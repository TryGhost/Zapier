...
describe('Creates', function () {
    describe('Create Post', function () {
        ...
        it('creates a post from html, mapping tag and author slugs', function () {
            ...
            return appTester(App.creates.create_post.operation.perform, bundle).then((post) => {
        ...
        it('requires published_at when the post is scheduled', function () {
            ...
            return appTester(
                App.creates.create_post.operation.inputFields[PUBLISHED_AT_FIELD],
                bundle,
            ).then(([field]) => {
        ...
        it('shows the html content field for html format', function () {
            ...
            return appTester(
                App.creates.create_post.operation.inputFields[CONTENT_FIELD],
                bundle,
            ).then(([field]) => {
