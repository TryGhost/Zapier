...
describe('Searches', function () {
    describe('Author', function () {
        ...
        it('fetches an author by email', function () {
            ...
            apiMock.get('/ghost/api/admin/users/email/ghost-author@example.com/').reply(200, {
                users: [
                    {
                        slug: 'ghost',
            ...
            return appTester(App.searches.author.operation.perform, bundle).then((results) => {
        ...
        it('fetches an author by slug', function () {
            ...
            apiMock.get('/ghost/api/admin/users/slug/ghost/').reply(200, {
                users: [
                    {
                        slug: 'ghost',
                        id: '5951f5fca366002ebd5dbef7',
        ...
        it('handles a 404', function () {
            ...
            apiMock.get('/ghost/api/admin/users/email/unknown@example.com/').reply(404, {
                errors: [
                    {
        ...
        describe('dynamic input fields', function () {
            ...
            it('shows the email field when searching by email', function () {
                ...
                return appTester(
                    App.searches.author.operation.inputFields[SEARCH_TERM_FIELD],
                    bundle,
                ).then(([field]) => {
        ...
        it('handles a validation error', function () {
            ...
            apiMock.get('/ghost/api/admin/users/email/unknown/').reply(422, {
                errors: [
                    {
            ...
            return appTester(App.searches.author.operation.perform, bundle).then(
                () => {
