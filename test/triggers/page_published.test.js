...
describe('Triggers', function () {
    describe('Page Published', function () {
        ...
        it('loads page from webhook data', function () {
            ...
            return appTester(App.triggers.page_published.operation.perform, bundle).then(
                ([page]) => {
        ...
        it('loads page from list', function () {
            ...
            return appTester(App.triggers.page_published.operation.performList, bundle).then(
                (results) => {
        ...
        it('subscribes to webhook', function () {
            ...
            return appTester(App.triggers.page_published.operation.performSubscribe, bundle).then(
                () => {
                    expect(apiMock.isDone()).toBe(true);
                },
            );
        ...
        it('unsubscribes from webhook', function () {
            ...
            return appTester(App.triggers.page_published.operation.performUnsubscribe, bundle).then(
                () => {
                    expect(apiMock.isDone()).toBe(true);
                },
            );
