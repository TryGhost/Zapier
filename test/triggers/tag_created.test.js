...
describe('Triggers', function () {
    describe('Tag Created', function () {
        ...
        it('loads tag from webhook data', function () {
            ...
            return appTester(App.triggers.tag_created.operation.perform, bundle).then(([tag]) => {
        ...
        it('loads latest tag from list', function () {
            ...
            return appTester(App.triggers.tag_created.operation.performList, bundle).then(
                (results) => {
        ...
        it('subscribes to webhook', function () {
            ...
            return appTester(App.triggers.tag_created.operation.performSubscribe, bundle).then(
                () => {
                    expect(apiMock.isDone()).toBe(true);
                },
            );
        ...
        it('unsubscribes from webhook', function () {
            ...
            return appTester(App.triggers.tag_created.operation.performUnsubscribe, bundle).then(
                () => {
                    expect(apiMock.isDone()).toBe(true);
                },
            );
