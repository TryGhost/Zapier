...
describe('Triggers', function () {
    describe('Post Scheduled', function () {
        ...
        it('loads post from webhook data', function () {
            ...
            return appTester(App.triggers.post_scheduled.operation.perform, bundle).then(
                ([post]) => {
        ...
        it('loads post from list', function () {
            let bundle = Object.assign(
                {},
                { authData },
                {
            ...
            return appTester(App.triggers.post_scheduled.operation.performList, bundle).then(
                (results) => {
        ...
        it('subscribes to webhook', function () {
            let bundle = Object.assign(
                ...
                { authData },
                {
                    targetUrl: 'https://webooks.zapier.com/ghost/post_published',
                },
            );
                    ...
                    webhooks: [
                        {
                            ...
                            target_url: 'https://webooks.zapier.com/ghost/post_published',
            ...
            return appTester(App.triggers.post_scheduled.operation.performSubscribe, bundle).then(
                () => {
                    expect(apiMock.isDone()).toBe(true);
                },
            );
        ...
        it('unsubscribes from webhook', function () {
            ...
            return appTester(App.triggers.post_scheduled.operation.performUnsubscribe, bundle).then(
                () => {
                    expect(apiMock.isDone()).toBe(true);
                },
            );
