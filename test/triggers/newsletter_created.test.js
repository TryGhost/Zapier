...
describe('Triggers', function () {
    describe('Newsletter Created', function () {
        ...
        it('loads newsletter from webhook data', function () {
            ...
            return appTester(App.triggers.newsletter_created.operation.perform, bundle).then(
                ([newsletter]) => {
        ...
        it('loads newsletter from list', function () {
            ...
            return appTester(App.triggers.newsletter_created.operation.performList, bundle).then(
                (results) => {
        ...
        it('subscribes to webhook', function () {
            ...
            return appTester(
                App.triggers.newsletter_created.operation.performSubscribe,
                bundle,
            ).then(() => {
                expect(apiMock.isDone()).toBe(true);
            });
        ...
        it('unsubscribes from webhook', function () {
            ...
            return appTester(
                App.triggers.newsletter_created.operation.performUnsubscribe,
                bundle,
            ).then(() => {
                expect(apiMock.isDone()).toBe(true);
            });
