...
describe('Triggers', function () {
    describe('Post Published', function () {
        ...
        it('loads post from webhook data', function () {
            ...
            return appTester(App.triggers.post_published.operation.perform, bundle).then(
                ([post]) => {
        ...
        it('loads post from list', function () {
            ...
            return appTester(App.triggers.post_published.operation.performList, bundle).then(
                (results) => {
        ...
        it('subscribes to webhook', function () {
            ...
            return appTester(App.triggers.post_published.operation.performSubscribe, bundle).then(
                () => {
                    expect(apiMock.isDone()).toBe(true);
                },
            );
        ...
        it('unsubscribes from webhook', function () {
            ...
            return appTester(App.triggers.post_published.operation.performUnsubscribe, bundle).then(
                () => {
                    expect(apiMock.isDone()).toBe(true);
                },
            );
