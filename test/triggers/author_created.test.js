...
describe('Triggers', function () {
    describe('Author Created', function () {
        ...
        it('loads author from webhook data', function () {
            ...
            return appTester(App.triggers.author_created.operation.perform, bundle).then(
                ([author]) => {
        ...
        it('loads latest author from list', function () {
            ...
            return appTester(App.triggers.author_created.operation.performList, bundle).then(
                (results) => {
        ...
        it('subscribes to webhook', function () {
            ...
            return appTester(App.triggers.author_created.operation.performSubscribe, bundle).then(
                () => {
                    expect(apiMock.isDone()).toBe(true);
                },
            );
        ...
        it('unsubscribes from webhook', function () {
            ...
            return appTester(App.triggers.author_created.operation.performUnsubscribe, bundle).then(
                () => {
                    expect(apiMock.isDone()).toBe(true);
                },
            );
